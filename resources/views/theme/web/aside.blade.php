          ...
          <ul id="iq-sidebar-toggle" class="iq-menu">
             <li class="active active-menu">
               ...
               <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                  <li class="{{request()->is('dashboard') ? 'active' : ''}}"><a href="{{route('dashboard.index')}}"><i class="las la-house-damage"></i>Home Page</a></li>
                  <li class="{{request()->is('booking') ? 'active' : ''}}"><a href="{{route('booking.index')}}"><i class="ri-checkbox-multiple-blank-line"></i>Request</a></li>
                  <li class="{{request()->is('dataruangan') ? 'active' : ''}}"><a href="{{route('dataruangan.index')}}"><i class="bi bi-card-list"></i>Data Ruangan</a></li>
                  <li class="{{request()->is('') ? 'active' : ''}}"><a href=""><i class="bi bi-clock-history"></i>History</a></li>
                </ul>
             </li>
             {{-- <li>
               ...
               <ul id="userinfo" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                   ...
                   <li class="{{request()->is('user') ? 'active' : ''}}"><a href="{{route('user.index')}}"><i class="las la-edit"></i>User Edit</a></li>
                      ...
                      <div class="iq-card shadow-none m-0">
                         <div class="iq-card-body p-0 ">
                            <div class="bg-primary p-3">
                               ...
                               <span class="text-white font-size-12">{{Auth::user()->nim}} - {{Auth::user()->prodi}}</span>
                            </div>
